          ...
          {step === 'form' && (
            <View style={styles.content}>
              <View style={styles.header}>
                <Text style={styles.title}>Transfer to Staking</Text>
              ...
              <View style={styles.body}>
                ...
                <View style={styles.balanceRow}>
                  <Text style={styles.balanceLabel}>Available in Spot:</Text>
              ...
              <View style={styles.body}>
                ...
                <View style={styles.warningBox}>
                  <Text style={styles.warningText}>
                    ⚠️ Once transferred, you must delegate to validators to earn rewards.
                  </Text>
                </View>
              </View>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.body}>
                <View style={styles.statusContainer}>
                  ...
                  <Text style={styles.statusText}>
                    Successfully transferred {amountNum.toFixed(6)} HYPE to staking balance
                  </Text>
            ...
            <View style={styles.content}>
              ...
              <View style={styles.body}>
                <View style={styles.statusContainer}>
                  ...
                  <Text style={styles.statusText}>Failed to transfer to staking</Text>
                  {error && <Text style={styles.errorText}>{error}</Text>}
                </View>
              </View>
